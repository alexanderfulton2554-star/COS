          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
            ...
            <div className="mt-8 flex flex-col-reverse gap-3 sm:flex-row sm:justify-between">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 disabled:cursor-not-allowed disabled:opacity-50 sm:justify-start"
              >
                <ArrowLeft className="h-4 w-4" /> Back
              </button>

              {currentStep < steps.length - 2 ? (
                <button type="button" onClick={nextStep} className="inline-flex items-center justify-center gap-2 rounded-full bg-sky-600 px-4 py-2 text-sm font-semibold text-white hover:bg-sky-500">
