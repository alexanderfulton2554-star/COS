      ...
      <section className="mx-auto max-w-7xl px-6 py-6 lg:px-10">
        <nav className="mb-10 flex flex-col gap-4 rounded-[24px] border border-slate-200 bg-white/90 px-4 py-3 shadow-sm backdrop-blur-sm sm:flex-row sm:items-center sm:justify-between sm:rounded-full sm:px-5">
          ...
          <div className="grid w-full grid-cols-2 gap-2 sm:w-auto sm:flex sm:items-center sm:gap-3">
            <Link href="/login" className="rounded-full border border-slate-200 px-3 py-2 text-center text-sm font-medium text-slate-700 transition hover:border-slate-300 hover:bg-slate-50 sm:px-4">Sign in</Link>
            <Link href="/register" className="rounded-full bg-sky-600 px-3 py-2 text-center text-sm font-medium text-white shadow-sm transition hover:bg-sky-500 sm:px-4">Create account</Link>
          </div>
        </nav>
